...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '192.168.1.144','102.218.138.59']
...
# Ajouter le middleware en tout début
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',
] + MIDDLEWARE

# Configurer les origines autorisées pour ton frontend React
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",         # si React tourne en local
    "http://192.168.8.165:3000",     # si React tourne sur un autre appareil du réseau
]
